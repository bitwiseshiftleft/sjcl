...
/** SHA3-224 sponge (using Keccak[448] {@link sjcl.hash.keccak448} with domain separation) */
sjcl.hash.sha3_224 = sjcl.hash.keccak(448, 0, 0, sha3_domain_pad);
/** SHA3-256 sponge (using Keccak[512] {@link sjcl.hash.keccak512} with domain separation) */
sjcl.hash.sha3_256 = sjcl.hash.keccak(512, 0, 0, sha3_domain_pad);
/** SHA3-384 sponge (using Keccak[768] {@link sjcl.hash.keccak768} with domain separation) */
sjcl.hash.sha3_384 = sjcl.hash.keccak(768, 0, 0, sha3_domain_pad);
/** SHA3-512 sponge (using Keccak[1024] {@link sjcl.hash.keccak1024} with domain separation) */
...
/** SHAKE128 sponge (using Keccak[256] {@link sjcl.hash.keccak256} with domain separation) */
sjcl.hash.shake128 = sjcl.hash.keccak(256, 0, 0, sha3_xof_domain_pad);
/** SHAKE256 sponge (using Keccak[512] {@link sjcl.hash.keccak512} with domain separation) */
